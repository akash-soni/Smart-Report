...
from reportlab.lib.pagesizes import letter # for page formatting in PDF generation
...
class AutonomousReportGenerator:
    ...
    def __init__(self, llm,tavily_key):
        self.llm = llm
...
if __name__ == "__main__":
    try:
        ...
        tavily_key = model_loader.load_tavily_api_key()
        reporter = AutonomousReportGenerator(llm,tavily_key)
